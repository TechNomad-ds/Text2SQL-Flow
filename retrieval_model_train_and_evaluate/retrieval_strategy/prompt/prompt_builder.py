...
def get_example_selector(selector_type: str):
    ...
    elif selector_type == SELECTOR_TYPE.COS_MASK_SIMILAR:
        selector_cls = CosineMaskSimilarExampleSelector
    elif selector_type == SELECTOR_TYPE.COS_SQL_SIMILAR:
        selector_cls = CosineSQLSimilarExampleSelector
    elif selector_type == SELECTOR_TYPE.COS_MASK_SQL_SIMILAR:
        selector_cls = CosineMaskSQLSimilarExampleSelector
    elif selector_type == SELECTOR_TYPE.COS_AST_SIMILAR:
        selector_cls = CosineASTSimilarExampleSelector
    ...
    elif selector_type == SELECTOR_TYPE.EUC_DISTANCE_SKELETON_SIMILARITY_THRESHOLD_MASK:
        selector_cls = EuclideanDistanceSkeletonSimilarThresholdMASKSelector
    ...
    elif selector_type == SELECTOR_TYPE.EMBED_MODEL:
        selector_cls = EmbedSelector
    elif selector_type == SELECTOR_TYPE.RERANK_MODEL:
        selector_cls = RerankSelector
    elif selector_type == SELECTOR_TYPE.EUCLIDEAN_DISTANCE_QUESTION_MASK_EMBED:
        selector_cls = EuclideanDistanceQuestionMaskEmbedSelector
    elif selector_type == SELECTOR_TYPE.AST_ZSS:
        selector_cls = AstZssSelector
    elif selector_type == SELECTOR_TYPE.AST_EMBED_MODEL:
        selector_cls = AST2EmbedSelector
    else:
